...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', '--Guide_Length', type=int, choices=range(10, 41, 1), metavar="[10-40]", default=20, help="Length of the guide sequence. Default: 20.")
    ...
    parser.add_argument('--edit_dist', type=int, default=6, choices=range(0, 21, 1), metavar="[0-20]",  help='Minimum number of mismatches allowed in the guide region to classify a sequence as candidate gRNA. Default value is 6.')
